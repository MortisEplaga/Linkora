const TRANSLATIONS = {
    en: {
        ...
        'points_referral_copied': 'Copied!',
        'points_referral_share_telegram': 'Telegram',
        'points_referral_share_whatsapp': 'WhatsApp',
        'points_referral_share_text': "Join me on Linkora — here's my invite link:",
        'points_referral_invited': 'Registered via your link',
        'points_referral_earned': 'Referral points earned',
        'points_referral_note': 'The link is built from your username, so it changes if you rename your account. Points are credited once the invited listing has been up for 7 days.',
        'points_referral_no_username': 'Set a username in your profile settings to get a referral link.',
        ...
        'media_size_exceeded': "Total media size exceeds 50 MB. Please remove some files.",
        'network_error': "Network error",
        'facebook_appsecret_not_configured': "Facebook: AppSecret is not configured",
        'failed_fetch_user_items': "Failed to fetch user items",
        'failed_resolve_filter': "Failed to resolve filter option",
        'failed_load_media': "Failed to load media",
        'subscription_toggle_failed': "Subscription toggle failed",
        'subscription_error': "Subscription error",
        'facebook_login_failed': "Facebook login failed",
        'engine_error': "Engine Error",
        'error_resolving_option': "Error resolving option",
        'map_view': "Map",
        'profile_address_title': "Address",
        'profile_home_address_label': "Home address",
        'profile_home_address_ph': "City, street, house",
        'profile_home_address_hint': "Applied by default to new listings. You can choose a different address for any individual listing.",
        'use_home_address_label': "Use my saved address",
        ...
        'registration_incomplete': 'Registration form is incomplete. Please reopen the registration dialog.',
        'report_select_reason': 'Please select a reason.',
        'error': 'Error',
    ...
    lv: {
        ...
        'points_referral_copied': 'Nokopēts!',
        'points_referral_share_telegram': 'Telegram',
        'points_referral_share_whatsapp': 'WhatsApp',
        'points_referral_share_text': 'Pievienojies Linkora — šī ir mana uzaicinājuma saite:',
        'points_referral_invited': 'Reģistrējušies pa tavu saiti',
        'points_referral_earned': 'Nopelnītie uzaicinājuma punkti',
        'points_referral_note': 'Saite ir veidota no tava lietotājvārda, tāpēc tā mainās, ja maini lietotājvārdu. Punkti tiek piešķirti, kad uzaicinātais sludinājums ir publicēts 7 dienas.',
        'points_referral_no_username': 'Iestati lietotājvārdu profila iestatījumos, lai saņemtu uzaicinājuma saiti.',
        ...
        'title_required': "Lūdzu, ievadiet virsrakstu",
        'media_size_exceeded': "Kopējais multivides izmērs pārsniedz 50 MB. Lūdzu, noņemiet dažus failus.",
        'network_error': "Tīkla kļūda",
        'facebook_appsecret_not_configured': "Facebook: AppSecret nav konfigurēts",
        'failed_fetch_user_items': "Neizdevās ielādēt lietotāja vienumus",
        'failed_resolve_filter': "Neizdevās atrisināt filtra opciju",
        'failed_load_media': "Neizdevās ielādēt multividi",
        'subscription_toggle_failed': "Abonementa pārslēgšana neizdevās",
        'subscription_error': "Abonementa kļūda",
        'facebook_login_failed': "Facebook pieteikšanās neizdevās",
        'engine_error': "Dzinēja kļūda",
        'error_resolving_option': "Kļūda, atrisinot opciju",
        'map_view': "Karte",
        'profile_address_title': "Adrese",
        'profile_home_address_label': "Mājas adrese",
        'profile_home_address_ph': "Pilsēta, iela, māja",
        'profile_home_address_hint': "Pēc noklusējuma tiek izmantota jauniem sludinājumiem. Jūs varat izvēlēties citu adresi katram atsevišķam sludinājumam.",
        'use_home_address_label': "Izmantot manu saglabāto adresi",
        ...
        'registration_incomplete': 'Reģistrācijas forma ir nepilnīga. Lūdzu, atveriet reģistrācijas logu vēlreiz.',
        'report_select_reason': 'Lūdzu, izvēlieties iemeslu.',
        'error': 'Kļūda',
        'captcha_required': 'Lūdzu, aizpildiet captcha.',
        'captcha_failed': 'Verifikācija neizdevās. Mēģiniet vēlreiz.',
        ...
        'complete_deal': 'Pabeigt darījumu',
        ...
        'footer_rules': "Noteikumi",
        'footer_policy': "Privātuma politika",
        'footer_contacts': "Kontakti",
        'rules_title': "Portāla lietošanas noteikumi",
        'policy_title': "Privātuma politika",
        'contacts_title': "Kontakti",
        'auth_rules_link': "noteikumiem",
        'auth_policy_link': "Privātuma politikai",
    ...
    ru: {
        ...
        'points_referral_copied': 'Скопировано!',
        'points_referral_share_telegram': 'Telegram',
        'points_referral_share_whatsapp': 'WhatsApp',
        'points_referral_share_text': 'Присоединяйтесь к Linkora — вот моя пригласительная ссылка:',
        'points_referral_invited': 'Зарегистрировались по вашей ссылке',
        'points_referral_earned': 'Начислено за приглашения',
        'points_referral_note': 'Ссылка основана на вашем имени пользователя, поэтому меняется при его смене. Поинты начисляются после того, как объявление приглашённого продержится 7 дней.',
        'points_referral_no_username': 'Укажите имя пользователя в настройках профиля, чтобы получить приглашенительную ссылку.',
        ...
        'media_size_exceeded': "Общий размер медиафайлов превышает 50 МБ. Пожалуйста, удалите некоторые файлы.",
        'network_error': "Ошибка сети",
        'facebook_appsecret_not_configured': "Facebook: AppSecret не настроен",
        'failed_fetch_user_items': "Не удалось загрузить элементы пользователя",
        'failed_resolve_filter': "Не удалось разрешить параметр фильтра",
        'failed_load_media': "Не удалось загрузить медиа",
        'subscription_toggle_failed': "Не удалось переключить подписку",
        'subscription_error': "Ошибка подписки",
        'facebook_login_failed': "Ошибка входа через Facebook",
        'engine_error': "Ошибка движка",
        'error_resolving_option': "Ошибка разрешения опции",
        'map_view': "Карта",
        'profile_address_title': "Адрес",
        'profile_home_address_label': "Домашний адрес",
        'profile_home_address_ph': "Город, улица, дом",
        'profile_home_address_hint': "Применяется по умолчанию для новых объявлений. Вы можете выбрать другой адрес для любого отдельного объявления.",
        'use_home_address_label': "Использовать мой сохранённый адрес",
        ...
        'registration_incomplete': 'Форма регистрации неполная. Пожалуйста, откройте диалог регистрации заново.',
        'report_select_reason': 'Пожалуйста, выберите причину.',
        'error': 'Ошибка',
        'captcha_required': 'Пожалуйста, заполните капчу.',
        'captcha_failed': 'Проверка не удалась. Попробуйте еще раз.',
        ...
        'deleted_success': 'Объявление удалено',
        ...
        'rules_title': "Правила пользования порталом",
        'policy_title': "Политика конфиденциальности",
        'contacts_title': "Контакты",
        'auth_rules_link': "правилам",
        'auth_policy_link': "политике конфиденциальности",
        'terms_title': "Правила пользования порталом объявлений",
        'footer_support': "Поддержка",
        'btn_close': 'Закрыть',
        'support_name_ph': "Ваше имя",
        'support_email_ph': "Email",
        'support_phone_ph': "Телефон",
